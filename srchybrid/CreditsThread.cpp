...
void CCreditsThread::InitText()
{
	...
	*/
	...
	m_arCredits.Add(_T("03:00:šMule"));
	sTmp.Format(_T("02:01:Version %s"),theApp.m_strCurVersionLong);
	m_arCredits.Add(sTmp);
	m_arCredits.Add(_T("01:06:Copyright (C) 2014 e1z0"));
	m_arCredits.Add(_T("S:20"));
	m_arCredits.Add(_T("01:06:šMule includes GeoLite data created by MaxMind,")); 
	...
	m_arCredits.Add(_T("02:07:people for translating šMule"));
	...
	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:04:Part of šMule is based on Kademlia:"));
	m_arCredits.Add(_T("S:5"));
