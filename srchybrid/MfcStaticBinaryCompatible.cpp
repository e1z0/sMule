...
// _WIN32_IE	  = 0x0560
//
// sMule is using different defines (see 'stdafx.h') to achieve backward
// compatibility with older Windows systems.
//
// Depending on the code which is taken from the MFC library or from sMule object
...
// sMule project. It has to be ensured in every aspect, that this CPP file is
