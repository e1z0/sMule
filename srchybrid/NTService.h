...
#define SZSERVICENAME        "sMule"
// displayed name of the service
#define SZSERVICEDISPLAYNAME "sMule %s as a service"
// displayed descrption for the service
#define SZSERVICEDESCR		 L"Provides capability to let šMule run as a NT system service."
