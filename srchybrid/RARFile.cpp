...
bool CRARFile::InitUnRarLib()
{
	...
	if (m_hLibUnRar == NULL)
		LogWarning(LOG_STATUSBAR, _T("Failed to initialize UNRAR.DLL. Download latest version of UNRAR.DLL from http://www.rarlab.com and copy UNRAR.DLL into šMule installation folder."));
