	...
	: CListCtrlItemWalk(this)
{
	...
	*/
	...
	m_eFileSizeFormat = (EFileSizeFormat)theApp.GetProfileInt(_T("sMule"), _T("SearchResultsFileSizeFormat"), fsizeDefault);
	SetSkinKey(L"SearchResultsLv");
}

void CSearchListCtrl::OnDestroy()
{
	theApp.WriteProfileInt(_T("sMule"), _T("SearchResultsFileSizeFormat"), m_eFileSizeFormat);
	__super::OnDestroy();
}
