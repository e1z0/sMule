...
typedef struct
{
	...
	CString	sLogin;
	//MORPH START - Added by SiRoB, Login Failed from šMule+
	CString sFailedLogin;
 	//MORPH END   - Added by SiRoB, Login Failed from šMule+
...
public:
	...
	CArray<UpDown>* GetPointsForWeb()	{return &m_Params.PointsForWeb;} // MobilšMule
protected:
