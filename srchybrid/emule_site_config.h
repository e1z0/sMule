...
//		for building šMule with VS2003.
//
...
// NOTE: šMule can not get compiled with VS2005 out of the box because the SDK
// which is shipped with VS2005 does not contain the ‘upnp.h’ header file - and
// this feature is not yet optional for compiling šMule. Thus you need to install
// an additional more recent SDK when compiling with VS2005.
//
// It is supposed that šMule can get compiled with VS2005 and the latest 
// "Windows Server 2003 (Windows XP) SDK" - but it was not yet verified.
//
// It is known that šMule can get compiled with VS2005 and the "Vista SDK 6.0/6.1".
// To compile šMule with the "Vista SDK 6.0/6.1", define 'HAVE_VISTA_SDK'.
