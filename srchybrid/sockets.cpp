...
void CServerConnect::ConnectionEstablished(CServerSocket* sender)
{
	...
	if (sender->GetConnectionState() == CS_WAITFORLOGIN)
	{
		...
		*/
		...
		// šMule Version (14-Mar-2004: requested by lugdunummaster (need for LowID clients which have no chance 
...
void CServerConnect::InitLocalIP()
{
	...
	// To weaken that problem at least for users which are binding šMule to a certain IP,
